...
const fetchEmployHistorySample = (dispatch) => async () => {
  try {
    ...
    console.log(`fetchEmployHistorySample ERROR:`, error)
...
const fetchEmployHistoryStatus = (dispatch) => async () => {
  ...
  try {
    ...
    console.log(`fetchEmployHistoryStatus ERROR:`, error)
    // await ngrokApi.post('/error', { error: error })
    return
  }
}
...
const fetchEmployHistorys = (dispatch) => async () => {
  ...
  try {
    ...
    console.log(`fetchEmployHistorys ERROR:`, error)
    // await ngrokApi.post('/error', { error: error })
    return
  }
}
...
const createEmployHistory = (dispatch) => async (formValues) => {
  ...
  try {
    ...
    console.log(`createEmployHistory ERROR:`, error)
    // await ngrokApi.post('/error', { error: error })
    return
  }
}
...
const editEmployHistory = (dispatch) => async (id, formValues) => {
  ...
  try {
    ...
    console.log(`editEmployHistory ERROR:`, error)
    // await ngrokApi.post('/error', { error: error })
    return
  }
}
...
const deleteEmployHistory = (dispatch) => async (id) => {
  ...
  try {
    ...
    console.log(`deleteEmployHistory ERROR:`, error)
    // await ngrokApi.post('/error', { error: error })
    return
  }
}
